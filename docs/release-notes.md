...
- Python 0.20.0 adds immutable `note.read_snapshot()` and structured
  ...
  `Doc.read/save` semantics are unchanged. Requires the matching Notes v2 API.
  [Contract and migration](notes-diffs.md); [deployment and acceptance receipts](https://github.com/dreamlake-ai/dreamlake-workspace/issues/706).

## Earlier source changes and independent acceptance gates
