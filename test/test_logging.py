...
class TestBasicLogging:
    ...
    def test_simple_log_local(self, local_episode, temp_workspace):
        """Test basic log message in local mode."""
        with local_episode(prefix="test/log-test") as episode:
    ...
    @pytest.mark.remote
    def test_simple_log_remote(self, remote_episode):
        """Test basic log message in remote mode."""
        with remote_episode(prefix="test/log-test-remote") as episode:
            episode.log("Test message from remote")
            # Remote mode sends to server

    def test_multiple_logs_local(self, local_episode, temp_workspace):
        """Test logging multiple messages."""
        with local_episode(prefix="test/multi-log") as episode:
            episode.log("Message 1")
            episode.log("Message 2")
            episode.log("Message 3")
            episode.log("Message 4")
            episode.log("Message 5")
    ...
    @pytest.mark.remote
    def test_multiple_logs_remote(self, remote_episode):
        """Test logging multiple messages in remote mode."""
        with remote_episode(prefix="test/multi-log-remote") as episode:
            for i in range(10):
                episode.log(f"Remote message {i}")


class TestLogLevels:
    """Tests for different log levels."""

    def test_all_log_levels_local(self, local_episode, temp_workspace):
        """Test all available log levels."""
        with local_episode(prefix="test/log-levels") as episode:
            episode.log("Debug message", level="debug")
            episode.log("Info message", level="info")
            episode.log("Warning message", level="warn")
            episode.log("Error message", level="error")
            episode.log("Fatal message", level="fatal")
    ...
    def test_default_log_level_local(self, local_episode, temp_workspace):
        """Test that default log level is 'info'."""
        with local_episode(prefix="test/default-level") as episode:
            episode.log("Default level message")
    ...
    def test_debug_level_local(self, local_episode, temp_workspace):
        """Test debug level logging."""
        with local_episode(prefix="test/debug-test") as episode:
            episode.log("Debug info: Variable x = 42", level="debug")
    ...
    def test_error_level_local(self, local_episode, temp_workspace):
        """Test error level logging."""
        with local_episode(prefix="test/error-test") as episode:
            episode.log("An error occurred during processing", level="error")
...
class TestLogMetadata:
    ...
    def test_log_with_simple_metadata_local(self, local_episode, temp_workspace):
        """Test logging with simple metadata."""
        with local_episode(prefix="test/meta-log") as episode:
            episode.log(
    ...
    @pytest.mark.remote
    def test_log_with_metadata_remote(self, remote_episode):
        """Test logging with metadata in remote mode."""
        with remote_episode(prefix="test/meta-log-remote") as episode:
            episode.log(
    ...
    def test_log_with_nested_metadata_local(self, local_episode, temp_workspace):
        """Test logging with nested metadata structures."""
        with local_episode(prefix="test/nested-meta") as episode:
            episode.log(
    ...
    def test_log_with_various_types_local(self, local_episode, temp_workspace):
        """Test logging metadata with various data types."""
        with local_episode(prefix="test/types-meta") as episode:
            episode.log(
                "Various types test",
                level="info",
                metadata={
...
class TestLogSequencing:
    ...
    def test_log_sequence_numbers_local(self, local_episode, temp_workspace):
        """Test that logs have sequential sequence numbers."""
        with local_episode(prefix="test/sequence") as episode:
            for i in range(10):
                episode.log(f"Message {i}")
    ...
    @pytest.mark.remote
    def test_log_sequence_numbers_remote(self, remote_episode):
        """Test log sequencing in remote mode."""
        with remote_episode(prefix="test/sequence-remote") as episode:
            for i in range(20):
                episode.log(f"Remote message {i}")

    def test_log_timestamps_local(self, local_episode, temp_workspace):
        """Test that all logs have timestamps."""
        with local_episode(prefix="test/timestamps") as episode:
            for i in range(5):
                episode.log(f"Message {i}")
...
class TestProgressLogging:
    ...
    def test_training_progress_local(self, local_episode, temp_workspace):
        """Test logging training progress."""
        with local_episode(prefix="test/progress") as episode:
            total_epochs = 10
    ...
    @pytest.mark.remote
    def test_training_progress_remote(self, remote_episode):
        """Test logging training progress in remote mode."""
        with remote_episode(prefix="test/progress-remote") as episode:
    ...
    def test_batch_progress_local(self, local_episode, temp_workspace):
        """Test logging batch-level progress."""
        with local_episode(prefix="test/batch-progress") as episode:
            total_batches = 100
...
class TestErrorLogging:
    ...
    def test_exception_logging_local(self, local_episode, temp_workspace):
        """Test logging exceptions with details."""
        with local_episode(prefix="test/exception-log") as episode:
            try:
    ...
    @pytest.mark.remote
    def test_exception_logging_remote(self, remote_episode):
        """Test logging exceptions in remote mode."""
        with remote_episode(prefix="test/exception-log-remote") as episode:
            try:
    ...
    def test_multiple_errors_local(self, local_episode, temp_workspace):
        """Test logging multiple errors."""
        with local_episode(prefix="test/multi-error") as episode:
            errors = [
                ValueError("Error 1"),
    ...
    def test_warning_logging_local(self, local_episode, temp_workspace):
        """Test warning level logging."""
        with local_episode(prefix="test/warning-log") as episode:
            episode.log("Learning rate might be too high", level="warn")
            episode.log("Gradient clipping applied", level="warn")
            episode.log("Memory usage above threshold", level="warn")
...
class TestLogEdgeCases:
    ...
    def test_empty_log_message_local(self, local_episode, temp_workspace):
        """Test logging empty message."""
        with local_episode(prefix="test/empty-log") as episode:
            episode.log("")
    ...
    def test_very_long_log_message_local(self, local_episode, temp_workspace):
        """Test logging very long message."""
        long_message = "A" * 10000
        with local_episode(prefix="test/long-log") as episode:
            episode.log(long_message)
    ...
    def test_log_with_special_characters_local(self, local_episode, temp_workspace):
        """Test logging messages with special characters."""
        special_message = "Special chars: \n\t\r\\ \"quotes\" 'apostrophes' 日本語 emoji 🚀"
        with local_episode(prefix="test/special-log") as episode:
            episode.log(special_message)
    ...
    def test_log_with_empty_metadata_local(self, local_episode, temp_workspace):
        """Test logging with empty metadata dict."""
        with local_episode(prefix="test/empty-meta") as episode:
            episode.log("Message with empty metadata", metadata={})
    ...
    def test_log_with_large_metadata_local(self, local_episode, temp_workspace):
        """Test logging with large metadata object."""
        large_metadata = {f"key_{i}": f"value_{i}" for i in range(100)}

        with local_episode(prefix="test/large-meta") as episode:
            episode.log("Message with large metadata", metadata=large_metadata)
    ...
    def test_rapid_logging_local(self, local_episode, temp_workspace):
        """Test rapid sequential logging."""
        with local_episode(prefix="test/rapid-log") as episode:
            for i in range(1000):
                episode.log(f"Rapid message {i}")
    ...
    @pytest.mark.remote
    def test_rapid_logging_remote(self, remote_episode):
        """Test rapid logging in remote mode."""
        with remote_episode(prefix="test/rapid-log-remote") as episode:
            for i in range(100):
                episode.log(f"Rapid remote message {i}")
